...
def get_col_info(spec):
    ...
    if spec == 'old_fictive_olfaction':
        ...
        arduino_dtypes = ['float64', 'int64', 'int64', 'int64','int64', 'float64', 'float64', 'float64', 'float64', 'float64', 'float64', 'int32', 'uint8']
    elif spec == 'fictive_olfaction':
        arduino_colnames = ['time', 'led1', 'led2', 'led3', 'led4', 'yaw', 'roll', 'pitch', 'accx', 'accy', 'accz', 'therm', 'olfled', 'pwm']
        arduino_dtypes = ['float64', 'int64', 'int64', 'int64','int64', 'float64', 'float64', 'float64', 'float64', 'float64', 'float64', 'int32', 'uint8', 'uint8']
    elif spec == 'basic_thermistor' or spec == 'bucket':
        arduino_colnames = ['time', 'led1', 'led2', 'led3', 'led4', 'yaw', 'roll', 'pitch', 'accx', 'accy', 'accz', 'therm']
        arduino_dtypes = ['float64', 'int64', 'int64', 'int64','int64', 'float64', 'float64', 'float64', 'float64', 'int32']
        ...
        arduino_dtypes = ['float64', 'int64', 'int64', 'int64','int64', 'int64']
    elif spec == "odor_on_wheel":
        arduino_colnames = ['time', 'led1', 'led2', 'led3', 'led4', 'wheel','thermistor','odor_ttl']
        arduino_dtypes = ['float64', 'int64', 'int64', 'int64','int64', 'int64','int64','int64']
